  ...
  return (
    <LegalLayout title="Privacy Policy">
      ...
      <ul className="list-disc pl-6 space-y-2 text-zinc-650 dark:text-zinc-400">
        ...
        <li><strong>Ad-Supported Exceptions:</strong> While premium utility applications like Pilot Logbook remain entirely free of advertising and third-party tracking, some of our free games (such as Game Vault) display advertisements served by Google AdMob. Other games, including Neon Siege, do not currently display ads or integrate advertising SDKs. AdMob may collect and process device identifiers and usage statistics for ad-supported games as detailed in Section 5.</li>
      </ul>
      ...
      <p>
        To ensure complete transparency, we disclose that our Applications do not request or utilize sensitive system-level permissions, including but not limited to GPS background location, contacts, address books, or microphone access. The only exception is Pilot Logbook, which requests camera access solely for scanning paper logbooks and aviation documents. On iPhone/iPad, this scanning is processed on-device by default; you can optionally enable cloud AI-enhanced extraction for uploaded photos, and web-based scanning (which has no on-device scanner) always uses cloud AI. When cloud AI extraction is used, the file is sent securely to Anthropic&apos;s Claude API solely to extract logbook data &mdash; it is not used to train Anthropic&apos;s models, is automatically deleted from Anthropic&apos;s systems within 30 days, and is not stored by us after processing. See the Pilot Logbook Privacy Policy for full details.
      </p>
      <p>
      ...
      <p>
        To support the ongoing development of our free-to-play games, Game Vault integrates the Google Mobile Ads (AdMob) SDK. Other applications, including Neon Siege, do not currently display ads. When you play ad-supported games, AdMob may collect, process, and share specific device-level identifiers.
      </p>
      <ul className="list-disc pl-6 space-y-2 text-zinc-650 dark:text-zinc-400">
