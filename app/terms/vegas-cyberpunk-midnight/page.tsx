...
export default function VegasCyberpunkTermsPage() {
  return (
    <LegalLayout title="Terms of Service — Vegas Cyberpunk Midnight">
      ...
      <p>
        The free version of Vegas Cyberpunk Midnight displays third-party advertisements served by Google AdMob. By using the App, you acknowledge that you may interact with ad content served by third parties. {site.name} does not control, endorse, or assume responsibility for the availability, content, products, or services promoted in these advertisements.
      </p>
