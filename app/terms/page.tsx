...
export default function TermsPage() {
  return (
    <LegalLayout title="Terms of Service">
      ...
      <p>
        Some of our Applications (specifically free-to-play games like Game Vault) are supported by advertisements served by third-party ad networks (specifically Google AdMob). Other applications, including Neon Siege, do not currently display ads; a future update may add optional rewarded ads, and this policy will be updated before that happens.
      </p>
      <p>
