...
export default function NeonSiegeTermsPage() {
  return (
    <LegalLayout title="Terms of Service — Neon Siege">
      ...
      <p>
        The free version of Neon Siege displays third-party advertisements served by Google AdMob.
      </p>
      <p>
        By using the App, you acknowledge that you may interact with ad content served by third parties.
      </p>
      <p>
        {site.name} does not control, endorse, or assume responsibility for the availability, content, products, or services promoted in these advertisements.
      </p>
