  ...
  return (
    <footer className="border-t border-zinc-200 dark:border-zinc-800 pt-12 pb-10 px-6 text-center">
      <div className="max-w-7xl mx-auto flex flex-col gap-6">
        ...
        {/* Disclaimer */}
        <p className="text-[10px] text-zinc-400 dark:text-zinc-600 leading-relaxed text-center border-t border-zinc-200/80 dark:border-zinc-800/80 pt-6">
          Apple, App Store, and iCloud are trademarks of Apple Inc., registered in the U.S. and other countries.
        </p>
      </div>
    </footer>
  );
